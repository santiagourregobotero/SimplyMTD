...
namespace SimplyMTD.Pages
{
    public partial class ApplicationUsers
    {
        ...
        protected IEnumerable<SimplyMTD.Models.ApplicationUser> users;
        protected RadzenDataGrid<SimplyMTD.Models.ApplicationUser> grid0;
        ...
        protected async Task RowSelect(SimplyMTD.Models.ApplicationUser user)
        {
        ...
        protected async Task DeleteClick(SimplyMTD.Models.ApplicationUser user)
        {
            try
            {
